...
public class GoGUIIntegrator implements GOGUI {
	 ...
	 * GO GUI.
	 * 
	 * @param showStartupAnimation
	 *            if true then a startup animation will be shown when the GO GUI is
	 *            started.
	 * @param mode3D
	 *            if true then the stones will be shown in 3D. Otherwise a 2D
	 *            representation will be used.
	 * @param boardSize
	 *            the desired initial board size.
	 */
